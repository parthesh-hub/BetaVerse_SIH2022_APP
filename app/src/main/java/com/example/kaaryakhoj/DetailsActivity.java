...
public class DetailsActivity extends AppCompatActivity {
    ...
    String jobId1,startdate,enddate,userId,shortage;
...
//                                String companyName = companyId.companyName ;
                        ...
                        shortage = (String) job.get("vacancy");
...
//                    Log.d(TAG, "get failed with ", task.getException());
    ...
    private void setJobRecord(List<String> dateArray1) {
        int short1 = Integer.parseInt(shortage);
        short1 = short1-1;
...
//                        Log.w(TAG, "Error adding document", e);
        ...
        db.collection("jobs").document(jobId1).update("vacancy",Integer.toString(short1))
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        System.out.println("Success");
