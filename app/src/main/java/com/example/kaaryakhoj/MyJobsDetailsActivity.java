...
//    String userID = currentUser.getPhoneNumber();
    ...
    public void setDisplay(jobDetails model){
        TextView jobName = findViewById(R.id.myjobs_details_jobType);
        TextView jobDesc = findViewById(R.id.myjobs_details_jobDesc);
        TextView companyName = findViewById(R.id.myjobs_details_companyName);
        TextView dailyWage = findViewById(R.id.myjobs_details_dailyWage);
        TextView jobLocation = findViewById(R.id.myjobs_details_Location);
        TextView startDate = findViewById(R.id.myjobs_details_startDate);
        TextView endDate = findViewById(R.id.myjobs_details_endDate);
        TextView startTime = findViewById(R.id.myjobs_details_startTime);
        TextView endTime = findViewById(R.id.myjobs_details_endTime);
        TextView contact = findViewById(R.id.myjobs_details_jobContact);
