...
public class PreviousJobsAdapter extends RecyclerView.Adapter<PreviousJobsAdapter.Viewholder>{

    private Context context;
    private ArrayList<previousjobDetails> jobsArrayList;

    public PreviousJobsAdapter(Context context, ArrayList<previousjobDetails> jobsArrayList) {
    ...
    @NonNull
    @Override
    public PreviousJobsAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // to inflate the layout for each item of recycler view.
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.findjobs_card_layout, parent, false);
        return new PreviousJobsAdapter.Viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PreviousJobsAdapter.Viewholder holder, int position) {
        // to set data to textview and imageview of each card layout
        previousjobDetails model = jobsArrayList.get(position);
...
//        holder.companyName.setText(model.getCompanyname());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context,PreviousJobsDetailsActivity.class);
