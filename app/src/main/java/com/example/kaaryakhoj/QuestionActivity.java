...
public class QuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setNo = getIntent().getIntExtra("SET",1);
    ...
    {
        questionList.clear();
        System.out.println("SETLIST: "+(String) catList.get(selected_cat_index).getId()+(String) setsIDs.get(setNo));
        firestore.collection("Quiz").document(catList.get(selected_cat_index).getId())
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        QueryDocumentSnapshot quesListDoc  = docList.get(setsIDs.get(setNo));

//                        String count = quesListDoc.getString("COUNT");
                        Integer count= queryDocumentSnapshots.size();
